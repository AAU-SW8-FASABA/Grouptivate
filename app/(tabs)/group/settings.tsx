...
export default function GroupSettings() {
  const members = ["Anders", "Albert Hald", "Alfred", "Aske", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"];
    ...
    <>
      ...
      <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 20 }}>
        <Collapsible title="Members">
          ...
          <View style={[styles.row, { marginTop: 10, justifyContent: "center" }]}>
            <UniversalIcon source={IconSource.FontAwesome6} name="circle-plus" size={24} />
        ...
        <View style={{marginTop: 25}}>
          ...
          <CollapsibleContainer>
            <View style={[styles.row, { justifyContent: "space-between", marginRight: 50}]}>
              <Text style={[styles.text, { fontSize: 24 }]}>Anders</Text>
              <UniversalIcon source={IconSource.FontAwesome6} name="plus" size={24} />
            </View>
            <Text>Hello 2</Text>
          </CollapsibleContainer>
        </View>
